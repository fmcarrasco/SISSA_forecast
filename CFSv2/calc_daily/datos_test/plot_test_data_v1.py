...
v1_o = './test_v1_original.nc'
v1_i = './test_v1_interpolado.nc'
v1_iro = './test_v1_original_iris.nc'
v1_iri = './test_v1_interpolado_iris.nc'
...
for indice, tiempo in zip(indices, tiempos):
    ...
    plt.savefig('v1_' + str(indice).zfill(2) + '.jpg', dpi=150, bbox_inches='tight')
    plt.close(fig)
